              ...
              {experiences.map((exp) => {
                ...
                return (
                  <div
                    ...
                    className="group flex flex-col overflow-hidden bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 rounded-2xl relative cursor-pointer"
                  >
                    {/* Visual Card Media */}
                    ...
                    <div className="flex flex-1 flex-col p-5 space-y-2.5">
                      ...
                      {/* Direct Booking & WhatsApp Chat Actions */}
                      <div className="flex gap-2 pt-3 border-t border-slate-100/80">
                        <a
                          href={`https://wa.me/94771234567?text=Hi%20${encodeURIComponent(exp.hostName)},%20I%20would%20like%20to%20book%20a%20stay%20at%20your%20homestay%20"${encodeURIComponent(exp.title)}"%20on%20LankaStay.%20Please%20let%20me%20know%20availability!`}
                          target="_blank"
                        ...
                        <button
                          ...
                          className="flex-1 flex items-center justify-center bg-slate-900 hover:bg-slate-800 text-white text-[10px] font-black uppercase tracking-wider py-2.5 rounded-xl transition-all shadow-sm active:scale-95"
                        >
                          Details
                        </button>
                      </div>
