...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-green-950 border-t border-green-900 text-green-400">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12 text-left">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2.5 group">
              <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-600 text-white shadow-md shadow-emerald-500/25 group-hover:scale-105 transition-transform duration-250">
                <Compass className="h-4.5 w-4.5" />
              </span>
              <span className="text-xl font-bold tracking-tight text-white font-serif">
                Lanka<span className="text-emerald-400 font-sans font-extrabold">Stay</span>
              </span>
            </Link>
            ...
            <div className="border border-green-900 bg-green-900/40 p-4 rounded-xl max-w-xs space-y-2 mt-4">
              <div className="flex items-center gap-1.5 text-xs font-bold text-green-300">
                <ShieldCheck className="h-4 w-4 text-emerald-400" />
                <span>SLTDA Compliant Vetting</span>
              </div>
              <p className="text-[10px] text-green-500 leading-relaxed font-semibold">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="space-y-3.5 text-xs">
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:support@lankastay.lk" className="hover:text-emerald-400 transition-colors">support@lankastay.lk</a>
                </li>
                <li className="flex items-center gap-3">
                  <Phone className="h-4 w-4 text-emerald-500 shrink-0" />
                  <a href="tel:+94112345678" className="hover:text-emerald-400 transition-colors">+94 (11) 234-5678</a>
                </li>
                <li className="flex items-center gap-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-3">
                <a href="#" aria-label="Facebook" className="h-8 w-8 rounded-lg bg-green-900 border border-green-800 flex items-center justify-center text-green-400 hover:text-white hover:border-green-700 transition-colors">
                  <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
                    <path d="M9 8H7v3h2v9h4v-9h3.6l.4-3h-4V6.5C13 5.3 13.8 5 14.5 5H17V2h-3.5C9.9 2 9 3.5 9 5.8V8z" />
                  </svg>
                </a>
                <a href="#" aria-label="Instagram" className="h-8 w-8 rounded-lg bg-green-900 border border-green-800 flex items-center justify-center text-green-400 hover:text-white hover:border-green-700 transition-colors">
                ...
                <a href="#" aria-label="Twitter" className="h-8 w-8 rounded-lg bg-green-900 border border-green-800 flex items-center justify-center text-green-400 hover:text-white hover:border-green-700 transition-colors">
                  <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
        ...
        <div className="border-t border-green-900 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] text-green-500 font-medium">
